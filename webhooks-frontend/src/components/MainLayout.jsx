...
import { Sun, Moon, Copy } from "@bigbinary/neeto-icons";
        ...
        <nav style={{ flex: 1, padding: "0 1rem" }}>
          ...
          <button
            style={{
              ...
              borderRadius: "8px",
              border: "none",
              backgroundColor: activeTab === "composer" ? "#059669" : "transparent",
              color: "#ffffff",
              fontSize: "0.875rem",
              fontWeight: 500,
              cursor: "pointer",
        ...
        <header style={{
          ...
          <div>
            <h1 style={{
              ...
              {activeTab === "dashboard" ? "Webhook Dashboard" : "Request Composer"}
            </h1>
            <p style={{
